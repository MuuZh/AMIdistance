...
a_AR = linspace(0,1,num_segments);
a_AR = a_AR(randperm(num_segments));

result_series = [];
for i = 1:num_segments
    result_series = [result_series; MkSg_AR(series_length, a_AR(i), eta)];
end
...
for i = 1:num_windows
    ...
    for j = 1:w
        ...
        AC1_vector(j) = (CO_AutoCorr(current_window, 1, AC_using_method));
        AMI1_vector(j) = (IN_AutoMutualInfo(current_window, 1, AMI_using_method));
    end
